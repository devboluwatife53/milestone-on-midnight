...
class _MilestonePost_0 {
  ...
  fromValue(value_0) {
    return {
      ...
      parentId: _descriptor_1.fromValue(value_0),
      author: _descriptor_2.fromValue(value_0),
      label: _descriptor_3.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_1.toValue(value_0.id).concat(_descriptor_1.toValue(value_0.parentId).concat(_descriptor_2.toValue(value_0.author).concat(_descriptor_3.toValue(value_0.label))));
  }
}

const _descriptor_4 = new _MilestonePost_0();
...
export class Contract {
    ...
    this.circuits = {
      post: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_3.toValue(label_0),
        ...
        const result_0 = this._post_0(context, partialProofData, label_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      reply: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`reply: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const parentId_0 = args_1[1];
        const label_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('reply',
                                     'argument 1 (as invoked from Typescript)',
                                     'milestone.compact line 43 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(parentId_0) === 'bigint' && parentId_0 >= 0n && parentId_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('reply',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(parentId_0).concat(_descriptor_3.toValue(label_0)),
        ...
        const result_0 = this._reply_0(context,
                                       partialProofData,
                                       parentId_0,
                                       label_0);
        partialProofData.output = { value: [], alignment: [] };
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('reply', new __compactRuntime.ContractOperation());
  ...
  _post_0(context, partialProofData, label_0) {
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newArray()
                                                          .arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_4.toValue(tmp_1),
  ...
  _reply_0(context, partialProofData, parentId_0, label_0) {
    __compactRuntime.assert(parentId_0 > 0n, 'Invalid parent post');
    __compactRuntime.assert(parentId_0
                            <=
                            _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                           ...
                                                                           { push: { storage: false,
                                                                                     value: __compactRuntime.StateValue.newCell(__compactRuntime.alignedConcat(
                                                                                                                                  { value: _descriptor_11.toValue(0n),
                                                                                                                                    alignment: _descriptor_11.alignment() },
                                                                                                                                  { value: _descriptor_4.toValue({ id: 0n, parentId: 0n, author: new Uint8Array(32), label: '' }),

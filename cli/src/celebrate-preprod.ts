 ...
 * contract on Preprod. The percentage is a private circuit argument
 * (1-100) — it never touches the ledger unless it pushes your hidden
 * running progress past 100% (one completed goal). When it does, `label`
 * (the achievement text, e.g. "got a new car") is posted to the public
 * feed alongside the tier reached.
 *
 * Usage:
 *   CONTRACT_ADDRESS=<address> \
 *   WALLET_SEED=<hex> IDENTITY_SECRET_KEY=<hex> \
 *   PERCENT=40 LABEL="got a new car" npm run celebrate:preprod
 */
